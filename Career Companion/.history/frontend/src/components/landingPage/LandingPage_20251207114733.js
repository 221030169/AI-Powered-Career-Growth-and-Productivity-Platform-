          ...
          <section className="min-h-fit mb-10 md:mb-44 bg-cream dark:bg-navy" id="about">
            <div className="flex flex-col lg:flex-row items-center justify-center">
              ...
              <div className="text-center md:text-left w-full lg:w-2/3 p-8">
                ...
                <p className=" text-blue mb-6 md:ml-10 text-2xl font-medium dark:text-gray-400">
                  At <span className="txt-lorange">Career Companion</span>, we understand that job hunting can be a daunting process. That's why we're here to support you every step of the way. Whether you're a recent graduate or an experienced professional, our platform can help you land your dream job.
                </p>
                <p className=" text-bluee md:ml-10 text-2xl font-medium dark:text-gray-400">
              ...
              <div className="grid gap-8 mb-6 lg:mb-16 md:grid-cols-2">
                <div className="md:h-72 p-4 md:p-0 items-center bg-[#FFFFFF] border-2 border-lorange rounded-lg shadow sm:flex dark:bg-blue dark:border-lorange">
                  ...
                  <div className="">
                    ...
                    <p className="mt-3 mb-4 font-light text-lblue dark:text-gray-300 px-2">Priyansh loves coding, exploring the and feeding his wanderlust.</p>
                ...
                <div className="md:h-72 p-4 md:p-0 items-center bg-[#FFFFFF] border-2 border-lorange rounded-lg shadow sm:flex dark:bg-blue dark:border-lorange">
                  ...
                  <div className="">
                    ...
                    <p className="mt-3 mb-4 font-light text-lblue dark:text-gray-300 px-2">Naman is a rebel at heart. He expresses it by always putting pineapple on a pizza.</p>
                    <ul className="flex space-x-4 sm:mt-0 px-2">
                      <li>
                        <a href="#" className="text-navy hover:text-gray-900 dark:hover:text-white">
                        <HiOutlineDocumentText className="cursor-pointer text-2xl text-navy dark:text-lorange" />
                ...
                <div className="md:h-72 p-4 md:p-0 items-center bg-[#FFFFFF] border-2 border-lorange rounded-lg shadow sm:flex dark:bg-blue dark:border-lorange">
                  ...
                  <div className="">
                    ...
                    <span className="text-blue dark:text-gray-200 px-2">Full-Stack Web Developer</span>
                    <p className="mt-3 mb-4 font-light text-lblue dark:text-gray-300 px-2">Udit loves tutorials and story-telling. Perhaps he even loves the latter a bit too much.</p>
                    <ul className="flex space-x-4 sm:mt-0 px-2">
                      <li>
                        <a href="#" className="text-navy hover:text-gray-900 dark:hover:text-white">
                        <HiOutlineDocumentText className="cursor-pointer text-2xl text-navy dark:text-lorange" />
                ...
                <div className="md:h-72 p-4 md:p-0 items-center bg-[#FFFFFF] border-2 border-lorange rounded-lg shadow sm:flex dark:bg-blue dark:border-lorange">
                  ...
                  <div className="">
                    ...
                    <p className="mt-3 mb-4 font-light text-lblue dark:text-gray-300 px-2">Ashish has always been a class clown. Suffice to say he still is. Handsome though.</p>
                    <ul className="flex space-x-4 sm:mt-0 px-2">
                      <li>
                        <a href="#" className="text-navy hover:text-gray-900 dark:hover:text-white">
                        <HiOutlineDocumentText className="cursor-pointer text-2xl text-navy dark:text-lorange" />
        ...
        <footer className="bg-cream dark:bg-navy px-4 md:p-6 font-dm-sans-regular">
          <div className="w-full bg-cream dark:bg-navy pt-16 pb-10 h-100 ">
            <h4 className="text-xl text-center text-blue dark:text-cream">
              Made with ❤️ and ☕️ by Priyansh, Udit, Naman & Ashish!
            </h4>
          </div>
        </footer>
      </div>
