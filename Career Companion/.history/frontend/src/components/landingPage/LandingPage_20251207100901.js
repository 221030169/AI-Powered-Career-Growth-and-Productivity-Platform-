            ...
            <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
              ...
              <div className="grid gap-8 mb-6 lg:mb-16 md:grid-cols-2">
                <div className="md:h-72 p-4 md:p-0 items-center bg-[#FFFFFF] border-2 border-lorange rounded-lg shadow sm:flex dark:bg-blue dark:border-lorange">
                  <a href="#">
                    <img className="rounded-full p-2" src="/alex-avatar.png" alt="Alex Avatar" />
                  </a>
                  <div className="">
                ...
                <div className="md:h-72 p-4 md:p-0 items-center bg-[#FFFFFF] border-2 border-lorange rounded-lg shadow sm:flex dark:bg-blue dark:border-lorange">
                  <a href="#">
                    <img className="rounded-full p-2" src="/marcus-avatar.png" alt="Marcus Avatar" />
                  </a>
                  <div className="">
                    <h3 className="text-xl font-bold tracking-tight text-navy dark:text-cream px-2">
                      Naman Mittal
                ...
                <div className="md:h-72 p-4 md:p-0 items-center bg-[#FFFFFF] border-2 border-lorange rounded-lg shadow sm:flex dark:bg-blue dark:border-lorange">
                  <a href="#">
                    <img className="rounded-full p-2" src="/rachel-avatar.png" alt="Rachel Avatar" />
                  </a>
                  <div className="">
                    <h3 className="text-xl font-bold tracking-tight text-navy dark:text-cream px-2">
                      Udit Sharma
                ...
                <div className="md:h-72 p-4 md:p-0 items-center bg-[#FFFFFF] border-2 border-lorange rounded-lg shadow sm:flex dark:bg-blue dark:border-lorange">
                  <a href="#">
                    <img className="rounded-full p-2" src="/jordan-avatar.png" alt="Jordan Avatar" />
                  </a>
                  <div className="">
                    <h3 className="text-xl font-bold tracking-tight text-navy dark:text-cream px-2">
                      Ashish Agarwal
                ...
                <div className="md:h-72 p-4 md:p-0 items-center bg-[#FFFFFF] border-2 border-lorange rounded-lg shadow sm:flex dark:bg-blue dark:border-lorange">
                  <a href="#">
                    <img className="rounded-full p-2" src="/emma-avatar.png" alt="Emma Avatar" />
                  </a>
                  <div className="">
                    <h3 className="text-xl font-bold tracking-tight text-navy dark:text-cream px-2">
                      Mr. Aayush Sharma
